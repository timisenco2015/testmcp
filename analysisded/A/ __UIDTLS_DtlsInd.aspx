```json
{
	...
	"found": true,
	"summary": "The file is an ASP.NET web page that serves as a user interface for viewing information about individuals and non-clients. It includes HTML markup, client-side scripts, and server-side controls for displaying details.",
	"purpose": "The purpose of this file is to provide a user interface for displaying and interacting with information related to clients and non-clients within a web application.",
	"entities": [
		"UIDTLS_DtlsInd",
