```json
{
  ...
  "found": true,
  "summary": "The file is part of a user interface for handling client and non-client details, implemented using ASP.NET with HTML and JavaScript.",
  "purpose": "Defines the user interface for displaying and interacting with individual client and non-client details.",
  "entities": [
    "UIDTLS_DtlsInd",
